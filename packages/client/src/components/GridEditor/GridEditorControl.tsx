...
export const GridEditorControl: React.FC<GridEditorControlProps> = ({
  ...
  return (
    <React.Fragment>
      ...
      <Input name="amount" className="control-start" defaultValue={amount} onChange={handleChange} {...inputProps} />
      <Select name="unit" className="control-end" defaultValue={unit} onChange={handleChange} {...selectProps} />
    </React.Fragment>
  );
};
